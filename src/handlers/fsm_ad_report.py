...
from src.fsm_state import FSMAdReport, admin_check_order
from src.utils import update_cart_message, generate_view_order_text, generate_ad_report_text
...
async def process_waiting_resourser(
    ...
    text = await generate_ad_report_text(
